...
function() {
    ...
    this.setIdInRemote = function(e) {
        ...
        if (mozmill.remote.$('useXpath').checked == false) {
            ...
            if (e.target.id != "") {
                mozmill.remote.$("domExp").innerHTML = "ID: " + e.target.id + "<br> Content: " + v;

            }
            else if ((e.target.name != "") && (typeof(e.target.name) != "undefined")) {
                mozmill.remote.$("domExp").innerHTML = "Name: " + e.target.name + "<br> Content: " + v;

            }
            else if (e.target.nodeName == "A") {
                mozmill.remote.$("domExp").innerHTML = "Link: " + e.target.innerHTML + "<br> Content: " + v;

            }
            else {
                var stringXpath = getXSPath(e.target);
                mozmill.remote.$("domExp").innerHTML = 'XPath: ' + stringXpath + "<br> Content: " + v;
    ...
    this.aexplorerClick = function(e) {
        ...
        if (e.target.tagName == "OPTION") {
            ...
            mozmill.ui.remote.addAction(mozmill.ui.remote.buildAction('asserts.assertSelected', params));
            ...
            mozmill.ui.remote.addAction(mozmill.ui.remote.buildAction('asserts.assertValue', params));

        }
        else if (e.target.type == "checkbox") {
            //Assert checked
            mozmill.ui.remote.addAction(mozmill.ui.remote.buildAction('asserts.assertChecked', params));

        }
        else if (e.target.tagName == "DIV" || e.target.tagName == "SPAN") {
            //Assert text
            mozmill.ui.remote.addAction(mozmill.ui.remote.buildAction('asserts.assertNode', params));
            params['validator'] = e.target.innerHTML;
            mozmill.ui.remote.addAction(mozmill.ui.remote.buildAction('asserts.assertText', params));

        }
        else if (e.target.tagName == "IMG") {
            //Assert Image Loaded
            mozmill.ui.remote.addAction(mozmill.ui.remote.buildAction('asserts.assertImageLoaded', params));
    ...
    this.assertExplorerOn = function() {
        ...
        try {
            mozmill.remote.$('assertx').src = 'img/axoff.png';
            mozmill.remote.$('domExp').style.display = 'block';
            mozmill.remote.$('domExp').innerHTML = '';
            this.axRecursiveBind(mozmill.testWindow);
            ...
            mozmill.remote.$('assertx').src = 'img/axon.png';
    ...
    this.assertExplorerOff = function() {
        ...
        try {
            ...
            mozmill.remote.$('assertx').src = 'img/axon.png';
            mozmill.remote.$('domExp').style.visibility = 'hidden';
            mozmill.remote.$('domExp').innerHTML = '';
            this.axRecursiveUnBind(mozmill.testWindow);
