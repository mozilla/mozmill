 ...
 */
mozmill.helpers.normalizeNewlines = function(text)
{
    return text.replace(/\r\n|\r/g, "\n");
}
 ...
 */
mozmill.helpers.normalizeSpaces = function(text)
{
    ...
    if (browser.isSafari) {
	return mozmill.helpers.replaceAll(text, String.fromCharCode(160), " ");
    } else {
	return text.replace(nbspPattern, " ");
    }
}

mozmill.helpers.replaceAll = function(text, oldText, newText) {
